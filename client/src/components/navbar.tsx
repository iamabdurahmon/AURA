...
export function Navbar() {
  ...
  AURA
      ...
      <div className="hidden md:flex items-center gap-8">
        ...
        <a href="#contact" className="text-sm font-medium text-white/80 hover:text-primary transition-colors uppercase tracking-widest">About</a>
        <Link 
  href="#" 
  className="px-6 py-2 border border-white/20 rounded-full text-sm font-medium text-white hover:bg-primary hover:text-black hover:border-primary transition-all uppercase tracking-widest"
>
  Start Project
</Link>
      </div>
